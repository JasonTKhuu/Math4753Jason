...
#' \describe{
#'   \item{FIRE DAMAGE}{Cost of fire damage (in thousands of dollars)}
#'   \item{DISTANCe}{Distance of the fire station to the fire (in miles)}
#'   ...
#' }
#' @source Mendenhall, William M., and Terry Sincich. Statistics for Engineering and the Sciences. CRC Press, Taylor & Francis Group, 2016, pg. 541.
"fire"
